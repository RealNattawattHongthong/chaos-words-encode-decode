...
def encode(text):
    ...
    layer8 = base64.b64encode(layer6.encode()).decode()  # First encode
...
def decode(encoded_text):
    try:
        ...
        layer6 = base64.b64decode(layer8).decode()  # First decode
        layer6 = base64.b64decode(layer6).decode()  # Second decode
        layer6 = base64.b64decode(layer6).decode()  # Third decode
